                      ...
                      child: firstOtpSend ? Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            widget.hiveHandler.tempBox.put("oldnumber", widget.myData.mnum);
                            ...
                            response.then((value) {
                              if (value.statusCode == 200) {
                                ...
                                widget.hiveHandler.tempBox.put("oldnumid", json.decode(res)['id']);
                                setState(() {
                                  firstOtpSend = false;
                                  secondStep = true;
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            Map payload = {
                              ...
                              'id': widget.hiveHandler.tempBox.get("oldnumid"),
                            };
                            var body = json.encode(payload);
                      ...
                      child: thirdStep ? Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            widget.hiveHandler.tempBox.put("newnumber", newNumberController.text);
                            ...
                            response.then((value) {
                              ...
                              if (value.statusCode == 200) {
                                ...
                                print("resObj: $resObj");
                                widget.hiveHandler.tempBox.put("newnumid", resObj['id']);
                                  setState(() {
                                  thirdStep = false;
                                  fourthStep = true;
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            Map payload = {
                              ...
                              "number": widget.hiveHandler.tempBox.get("newnumber"),
                              "mid": widget.myData.mid,
                              "otpid": widget.hiveHandler.tempBox.get("newnumid"),
                            ...
                            response.then((value) {
                              if (value.statusCode == 200) {
                                ...
                                if (resObj["status"] == "successful") {
                                  widget.myData.mnum = widget.hiveHandler.tempBox.get("newnumber")!;
                                  widget.hiveHandler.userDataBox.put("userData",widget.myData.toJson());
                                  setState(() {
